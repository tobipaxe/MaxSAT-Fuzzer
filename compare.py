...
# 23-02 these are all weighted MaxSAT evaluation 22 solver
# see: https://maxsat-evaluations.github.io/2022/results/complete/weighted/summary.html
# PLEASE ADD OWN SOLVERS TO THE DICTIONARY IN THE FOLLOWING WAY
# wcnf file is added automatically by the script at the end of each solver_call
# directory (.) is in relation to THIS script
# YOURSOLVERNAME should be shorter than 22 symbols and only contains - letters, numbers and -
# solver["YOURSOLVERNAME"] = {
#     "solver_call" : "SOLVERCALL . is the folder of the current script",
#     "input_format": "wcnf" | "oldwcnf" | "mps"
#     "type": "complete" | "anytime"
#### TODO: Maybe to include a max for every solver: "maxValue": 2**64 | 2**32
solvers = {}
# # MSE 22 solver
# solvers["MSE22-Cashwmaxsat-CP"] = {
#   "solver_call": "./MSE22/Cashwmaxsat-CorePlus/bin/cashwmaxsatcoreplus -v0 -no-bin -no-sat -m -no-par -bm", "input_format": "wcnf", "type": "complete", "short": "CMSCP"}
# solvers["MSE22-Cashwmaxsat-Plus"] = {
#   "solver_call": "./MSE22/Cashwmaxsat-Plus/bin/cashwmaxsatplus -v0 -no-bin -no-sat -no-par -bm -m", "input_format": "wcnf", "type": "complete", "short": "CMSP"}
# solvers["MSE22-UWrMaxSat-SCIP"] = {
#   "solver_call": "./MSE22/UWrMaxSat-SCIP/bin/uwrmaxsat -v1 -no-bin -no-sat -no-par -scip-cpu=500 -m -bm", "input_format": "wcnf", "type": "complete", "short": "UMSS"}
# solvers["MSE22-MaxHS"] = {
#   "solver_call": "./MSE22/MaxHS/bin/maxhs -no-printOptions -printSoln -verb=0", "input_format": "wcnf", "type": "complete", "short": "MHS"}
# solvers["MSE22-WMaxCDCL"] = {
#     "solver_call": "./MSE22/WMaxCDCL/bin/wmaxcdcl_static",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "WMCDCL",
# }
# solvers["MSE22-WMaxCDCL-BandAll"] = {
#   "solver_call": "./MSE22/WMaxCDCL-BandAll/bin/wmaxcdcl_static", "input_format": "wcnf", "type": "complete", "short": "WMCDCLBA"}
# solvers["MSE22-UWrMaxSat"] = {
#   "solver_call": "./MSE22/UWrMaxSat/bin/uwrmaxsat -v1 -no-sat -no-bin -m -bm", "input_format": "wcnf", "type": "complete", "short": "UWM"}
solvers["MSE22-EvalMaxSAT"] = {
    "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE22/EvalMaxSAT/bin/EvalMaxSAT_bin",
    "input_format": "wcnf",
    "type": "complete",
    "short": "EMS",
}
solvers["Pac-PC-DPW-Release"] = {
    "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/CertifiedSolver/certified-pacose.sh",
    "input_format": "wcnf",
    "type": "certified",
    "short": "PPCDPW",
}
## ATTENTION: for CGSS python2 and the package python-six is needed
# solvers["MSE22-CGSS"] = {
#     "solver_call": "python2 ./MSE22/CGSS/bin/rc2.py --comp=a",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "CGSS",
# }
# solvers["MSE22-Exact"] = {
#     "solver_call": "./MSE22/Exact/bin/Exact_e17dbb7 --verbosity=0 --format=wcnf --output=maxsatnew --bits-overflow=30 --bits-reduced=25",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "Exact",
# }
# # ATTENTION: Z3 Solver calls are  more costly as the wcnf has to be transformed into the old format. This is done in the bash script.
# solvers["z3maxres"] = {
#    "solver_call": "./Others/z3maxres.sh", "input_format": "wcnf"}
# solvers["z3wmax"] = {
#    "solver_call": "./Others/z3wmax.sh", "input_format": "wcnf"}
# solvers["z3rc2"] = {
#    "solver_call": "./Others/z3rc2.sh", "input_format": "oldwcnf"}
# solvers["z3pd-maxres"] = {
#    "solver_call": "./Others/z3pd-maxres.sh", "input_format": "oldwcnf"}
# solvers["z3maxres-bin"] = {
#    "solver_call": "./Others/z3maxres-bin.sh", "input_format": "oldwcnf"}
# # MSE21 Version
# solvers["MSE21-Pacose"] = {
#    "solver_call": "./Others/Pacose.sh", "input_format": "oldwcnf"}
# # Preprocessor command line version
# solvers["maxpre2EvalMaxSAT"] = {
#    "solver_call": "./Others/maxpre2.sh", "input_format": "oldwcnf"}
# # Development Version of Pacose
# solvers["PacoseNew"] = {
#    "solver_call": "/usr/local/scratch/paxiant/gitlab/pacose-maxsat-solver/bin/Pacose", "input_format": "wcnf"}
# solvers["sat4j"] = {
...
# solvers["Pac-DGPW-UC"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding dgpw",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "dgpwUC",
# }
# solvers["Pac-Warners-UC"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding warn",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "warnUC",
# }
# solvers["Pac-bail"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding bail",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "bail",
# }
# solvers["Pac-asin"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding asin",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "asin",
# }
# solvers["Pac-ogaw"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding ogaw",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "ogaw",
# }
# solvers["Pac-bailw2"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding bailw2",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "bailw2",
# }
# solvers["Pac-wmt"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding wmt",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "wmt",
# }
# solvers["Pac-mrwto"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding mrwto",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "mrwto",
# }
# solvers["Pac-mrwto2"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding mrwto2",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "mrwto2",
# }
# solvers["Pac-mrwto19"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding mrwto19",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "mrwto19",
# }
# solvers["Pac-mrwto19x2"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding mrwto19_2",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "mrwto19x2",
# }
...
# solvers["QMS-mrwto19"] = {
#     "solver_call": "/home/paxiant/Downloads/QMaxSAT/code/qmaxsat_g3 -card=mrwto",
#     "input_format": "oldwcnf",
#     "type": "complete",
#     "short": "qmsm",
# }
# solvers["QMS-mrwto19x2"] = {
#     "solver_call": "/home/paxiant/Downloads/QMaxSAT/code/qmaxsat_g3 -card=mrwto2",
#     "input_format": "oldwcnf",
#     "type": "complete",
#     "short": "qmsm2",
# }
# solvers["Pac-PL-Warners"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver-Certified/bin/Pacose --encoding warn",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "PPLWar",
# }
# solvers["Pac-PC-Warn"] = {
#    "solver_call": "./CertifiedSolver/certified-pacose-warn.sh",
#    "input_format": "wcnf",
#    "type": "certified",
#    "short": "PPCWar",
# }
...
# solvers["Pac-DGPW"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/CertPac2nd/PacoseMaxSATSolver/bin/Pacose --encoding dgpw",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "PacDPW",
# }
# solvers["Pac-PL-DGPW"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver-Certified/bin/Pacose --encoding dgpw",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "PPLDPW",
# }
...
# solvers["Pac-DPW-Asmp"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/CertPac2nd/PacoseMaxSATSolver/bin/Pacose --encoding dgpw --WithAssumptions",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "PacAs",
# }
# solvers["Pac-PL-DPW-Asmp"] = {
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver-Certified/bin/Pacose --encoding dgpw --WithAssumptions",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "PPLAs",
# }
# solvers["Pac-PC-DPW-Asmp"] = {
#     "solver_call": "./CertifiedSolver/certified-pacose-assumptions.sh",
#     "input_format": "wcnf",
#     "type": "certified",
#     "short": "PPCAs",
# }
...
# solvers["PacosePLDGPW"] = {
#     # "solver_call": "./CertifiedSolver/certified-pacose-bug-preserving.sh",
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding dgpw",
#     #   "solver_call": "./CertifiedSolver/certified-pacose-run-only-pacose.sh",
#     "input_format": "wcnf",
#     "type": "certified",
#     "short": "PPLDPW",
# }
# solvers["PacoseWPLWarn"] = {
#     # "solver_call": "./CertifiedSolver/certified-pacose-bug-preserving.sh",
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/Pacose --encoding warn",
#     #   "solver_call": "./CertifiedSolver/certified-pacose-run-only-pacose.sh",
#     "input_format": "wcnf",
...
# solvers["PacoseWPLOld"] = {
#     # "solver_call": "./CertifiedSolver/certified-pacose-bug-preserving.sh",
#     "solver_call": "/usr/local/scratch/paxiant/gitlab/PacoseMaxSATSolver/bin/PacoseOld --encoding dgpw",
#     #   "solver_call": "./CertifiedSolver/certified-pacose-run-only-pacose.sh",
#     "input_format": "wcnf",
#     "type": "certified",
#     "short": "PLOld",
# }
# solvers["CertifiedCGSS"] = {
#     "solver_call": "./CertifiedSolver/certified-cgss.sh",
#     "input_format": "wcnf",
#     "type": "certified",
#     "short": "CCGSS",
# }
# solvers["CertifiedQMaxSAT"] = {
#    "solver_call": "./CertifiedSolver/certified-qmaxsat.sh",
#    "input_format": "oldwcnf",
#    "type": "certified",
#    "short": "CQMS",
# }
# solvers["toulbar2"] = {"solver_call": "./Others/toulbar2.sh", "input_format": "oldwcnf", "upper_bound": 512409557603043100, "type": "complete"}
# MIP Solver
# solvers["SCIP"] = {"solver_call": "./MIPSolver/SCIP.sh", "input_format": "mps", "upper_bound": 1000000, "type": "complete"}
# solvers["HiGHS"] = {"solver_call": "./MIPSolver/HiGHS.sh", "input_format": "mps", "upper_bound": 1000000, "type": "complete"}
# solvers["HiGHSITAD"] = {"solver_call": "./MIPSolver/HiGHS.sh", "input_format": "mps_itad", "upper_bound": 1000000, "type": "complete"}
# solvers["cbc"] = {"solver_call": "./MIPSolver/cbc.sh", "input_format": "mps_itad", "upper_bound": 1000000, "type": "complete"}
# MSE 23 Anytime Solver
# solvers["NuWLS-c-static"] = {
...
# }
# solvers["NuWLS-c-FPS"] = {
#     "solver_call": "./MSE23/anytime/NuWLS-c-FPS/bin/nuwls-c-fps_static",
#     "input_format": "wcnf",
#     "type": "anytime",
#     "short": "NuWcF",
# }
# solvers["NuWLS-c-Band"] = {
#     "solver_call": "./MSE23/anytime/NuWLS-c-Band/bin/nuwls-c-band_static",
#     "input_format": "wcnf",
#     "type": "anytime",
#     "short": "NuWcB",
# }
# solvers["tt-owi-IntelSATSolver"] = {
#     "solver_call": "./MSE23/anytime/TT-Open-WBO-Inc-23/bin/tt-open-wbo-inc-IntelSATSolver_static",
#     "input_format": "wcnf",
#     "type": "anytime",
#     "short": "towiI",
# }
# solvers["tt-owi-Glucose41"] = {
#     "solver_call": "./MSE23/anytime/TT-Open-WBO-Inc-23/bin/tt-open-wbo-inc-Glucose4_1_static",
#     "input_format": "wcnf",
#     "type": "anytime",
#     "short": "towiG",
# }
# solvers["LOANDRA"] = {
#     "solver_call": "./MSE23/anytime/Loandra/bin/loandra_static",
#     "input_format": "wcnf",
#     "type": "anytime",
#     "short": "LOAND",
# }
# solvers["NoSAT-MaxSAT"] = {
#     "solver_call": "./MSE23/anytime/noSAT-MaxSAT/bin/noSAT-MaxSAT",
#     "input_format": "wcnf",
#     "type": "anytime",
#     "short": "NS-MS",
# }
...
# solvers["WMaxCDCL-S6-HS12"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/WMaxCDCL-S6-HS12.sh",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "WMC61",
# }
# solvers["WMaxCDCL-S9-HS9"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/WMaxCDCL-S9-HS9.sh",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "WMC99",
# }
# solvers["EvalMaxSAT-SCIP"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/EvalMaxSAT/bin/EvalMaxSAT --timeUB 0 --minRefTime 5",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "EMSSC",
# }
# solvers["EvalMaxSAT"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/EvalMaxSAT/bin/EvalMaxSAT --timeSCIP 0 --timeUB 0 --minRefTime 5",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "EMS23",
# }
# solvers["CGSS2"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/CGSS2/bin/cgss2",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "CGSS2",
# }
# solvers["CGSS2-SCIP"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/CGSS2/bin/cgss2 --optimizer scip --optimizer-time 800",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "CGS2S",
# }
# solvers["CASHWMAXSAT-CorePlus"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/CASHWMaxSAT-CorePlus/bin/cashwmaxsatcoreplus -v0 -no-bin -no-sat -bm -no-par",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "CHMCP",
# }
# solvers["CASHWMAXSAT-CorePlus-m"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/CASHWMAXSAT-CorePlus-m/bin/cashwmaxsatcoreplus -v0 -no-bin -no-sat -m -bm -no-par",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "CHCPm",
# }
# solvers["Pacose-MaxPre2"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/Pacose/bin/Pacose --useMaxPre2",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "PacMP",
# }
# solvers["Pacose"] = {
#     "solver_call": "/usr/local/scratch/paxiant/MaxSATFuzzer/MaxSATSolver/MSE23/exact/Pacose/bin/Pacose",
#     "input_format": "wcnf",
#     "type": "complete",
#     "short": "Pacos",
# }
